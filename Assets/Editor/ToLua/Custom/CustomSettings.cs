...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(PackageItem)),
         _GT(typeof(RelationType)),
        _GT(typeof(EaseType)),
        _GT(typeof(PackageItemType)),
        _GT(typeof(ObjectType)),
        _GT(typeof(DestroyMethod)),
        ...
        _GT(typeof(ScrollBarDisplayType)),
        _GT(typeof(ListLayoutType)),
        _GT(typeof(ListSelectionMode)),
        _GT(typeof(ProgressTitleType)),
        _GT(typeof(ButtonMode)),
        _GT(typeof(TransitionActionType)),
        _GT(typeof(GroupLayoutType)),
        _GT(typeof(ChildrenRenderOrder)),
        _GT(typeof(PopupDirection)),
        _GT(typeof(FlipType)),
        _GT(typeof(FillMethod)),
        _GT(typeof(OriginHorizontal)),
        _GT(typeof(OriginVertical)),
        _GT(typeof(Origin90)),
        _GT(typeof(Origin180)),
        _GT(typeof(Origin360)),
        _GT(typeof(FocusRule)),
