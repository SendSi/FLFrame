...
---@class UI_talentItem : CS.FairyGUI.GComponent
--字段省略
local UI_talentItem = {};
--UI_talentItem.URL = "ui://04_general_information/talentItem";
function UI_talentItem:OnConstruct(windowCom)
	local tb = {
