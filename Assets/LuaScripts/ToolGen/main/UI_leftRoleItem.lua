...
---@class UI_leftRoleItem : CS.FairyGUI.GComponent
--字段省略
local UI_leftRoleItem = {};
--UI_leftRoleItem.URL = "ui://main/leftRoleItem";
function UI_leftRoleItem:OnConstruct(windowCom)
	local tb = {
