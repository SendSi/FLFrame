...
---@class UI_main_chat_item2 : CS.FairyGUI.GComponent
--字段省略
local UI_main_chat_item2 = {};
--UI_main_chat_item2.URL = "ui://main/main_chat_item2";
function UI_main_chat_item2:OnConstruct(windowCom)
	local tb = {
