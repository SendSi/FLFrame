...
---@class UI_comItem_size70 : CS.FairyGUI.GButton
--字段省略
local UI_comItem_size70 = {};
--UI_comItem_size70.URL = "ui://common/comItem_size70";
function UI_comItem_size70:OnConstruct(windowCom)
	local tb = {
