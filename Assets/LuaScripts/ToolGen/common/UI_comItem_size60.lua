...
---@class UI_comItem_size60 : CS.FairyGUI.GButton
--字段省略
local UI_comItem_size60 = {};
--UI_comItem_size60.URL = "ui://common/comItem_size60";
function UI_comItem_size60:OnConstruct(windowCom)
	local tb = {
