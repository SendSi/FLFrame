...
---@class UI_showTopTitle_Good : CS.FairyGUI.GButton
local UI_showTopTitle_Good = {};
function UI_showTopTitle_Good:OnConstruct(windowCom)
	local tb = {
